...
lint-py:  ## lint python with ruff
	python -m ruff check check_dist
	python -m ruff format --check check_dist
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix check_dist
	python -m ruff format check_dist
...
test:  ## run python tests
	python -m pytest -v check_dist/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v check_dist/tests --cov=check_dist --cov-report term-missing --cov-report xml
